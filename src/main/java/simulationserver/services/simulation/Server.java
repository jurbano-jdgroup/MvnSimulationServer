...
public class Server implements RTClientConnectionListener {
    ...
    @Getter private int port = 10080;
    @Getter private int backlog = 5;
    @Getter private int inputSampling = 1;
    @Getter  int outputSampling = 10;
    private java.net.ServerSocket server_socket;
    @Getter private boolean opened = false;
    /* clients track list */
    private final java.util.List<RTClient> clientsList;
    /** model */
    @Setter private RTAbstractModel model = null;
